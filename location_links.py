...
Скрипт берёт заведения из 2gis_clubs_geo.csv, ищет их в Яндекс Картах
через Selenium и сохраняет ссылки и др. инфу о найденных карточках.

Вход:  projvenv/2gis_clubs_geo.csv
Выход: projvenv/location_links.csv
"""
