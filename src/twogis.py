"""TwoGISAPIScraper — конкуренты-бильярдные через 2GIS Catalog API.

Статический парсинг через requests + JSON. Зональная стратегия (9 округов
× 3 запроса) обходит лимит бесплатного ключа.
"""
...
class TwoGISAPIScraper(BaseScraper):
    """2GIS Catalog API с зональной стратегией обхода лимитов бесплатного ключа."""

    API_URL = 'https://catalog.api.2gis.com/3.0/items'
    ZONE_CENTERS: list[tuple[str, str]] = [
    ...
    DEFAULT_QUERIES: list[str] = ['бильярд', 'снукер', 'бильярдный клуб']
